...
public class Sprint extends Module {
    ...
    private boolean flightActive() {
        return Client.instance.featureManager.getModuleByClass(Flight.class).getState();
    }
    ...
    public static boolean canusesprint() {
        ...
        if (Client.instance.featureManager.getModuleByClass(TeleportBack.class).getState()
                && TeleportBack.Mode.getCurrentMode().equals("Matrix")) {
            return false;
        }
    ...
    public static boolean acceptAllDir() {
        ...
        if (AllDirCondition.getCurrentMode().equals("Only Ground") && !pc.LastGround) {
            return MoveUtil.getmf() > 0;
        } else if (AllDirCondition.getCurrentMode().equals("Only Air") && pc.LastGround) {
            return MoveUtil.getmf() > 0;
        }

...
public static double frameTime=0;
    ...
    public void calculateCompensation(float targetX, float targetY, float xSpeed, float ySpeed) {
        ...
        x = AnimationHelper.calculateCompensation(targetX, this.x, (long) frameTime, deltaX);
        y = AnimationHelper.calculateCompensation(targetY, this.y, (long) frameTime, deltaY);
    }
